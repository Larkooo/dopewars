...
let rootUrl = URL(string: "https://rollyourown-git-offline.preview.cartridge.gg/")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["dopewars.game", "cartridge.gg", "x.cartridge.gg"]
